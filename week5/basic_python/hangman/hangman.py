...
def generate_word():
    random_words = [
        "nebula", "bicycle", "quench",
        "whisper", "glimmer", "syntax",
        "ocean", "velocity", "marmalade",
        "clover", "echo", "pinnacle",
        "safari", "riddle", "zenith",
        "fossil", "tundra", "labyrinth",
        "harvest", "spark",
    ]
...
def show_status(current_visual: str, guesses_left: int, wrong_letters: list):
